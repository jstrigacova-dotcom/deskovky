# 🎲 BoardGameGeek Data Analysis, Cleaning & Visualization

Tento projekt je zaměřen na kompletní proces zpracování, čištění a vizualizace rozsáhlého datasetu deskových her pocházejícího z platformy BoardGameGeek (BGG). Projekt demonstruje schopnost transformovat surová data z formátu CSV do strukturované relační databáze MySQL, provést datový audit, nápravu chyb a následně data modelovat a vizualizovat v nástroji Power BI.
...
* **Relační databáze:** MySQL / MySQL Workbench
* **Business Intelligence & Vizualizace:** Power BI
...
Prvním krokem bylo vytvoření databázového schématu a validace datových typů. Pomocí SQL příkazů byla ověřena konzistence importovaných dat vůči očekávané struktuře (číselné hodnoty, textové řetězce, datumy).

### 2. Validace a čištění dat (SQL)
V této fázi byl surový dataset zbaven šumu a nekonzistencí, které by mohly zkreslit výsledné analýzy. Proces zahrnoval:
